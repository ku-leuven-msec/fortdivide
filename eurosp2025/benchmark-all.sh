...
{
    ssh -t benchmark $__remon_dir/eurosp2025/fortdivide-libc.sh
    for __index in "${__index_sizes[@]}"
    do
        __output_file="$2$__index"
        echo "" > "$__output_file"
...
{
    ssh -t benchmark $__orig_remon_dir/scripts/switch_patched_binaries.sh ubuntu20
    for __index in "${__index_sizes[@]}"
    do
        __output_file="$2$__index"
        echo "" > "$__output_file"
...
function nginx-scan-benchmark
{
    ...
    logf "building nginx binaries with heap scanning"
    execute_and_wait "cd $__benchmark_dir/nginx-1.23.3/ && ./build.sh --ngx-split --pmvee-single-scanning --mappings-single-scanning --base 1>/dev/null"
    ...
    logf "Running nginx with $2 workers"
    execute_and_wait "sed -i 's/worker_processes.*/worker_processes $2;/g' $__benchmark_dir/nginx-1.23.3/conf/nginx.conf"

    __ld_preload=$__pmvee_ld_preload
    nginx-base   "$__benchmark_dir_out/nginx-1.23.3/base/sbin/nginx" "$__output_dir/$__connections-connections/nginx$1-$2-baseline"
    ...
    orig-server-bench "$__benchmark_dir_out/nginx-1.23.3/base/sbin/nginx" "$__output_dir/$__connections-connections/nginx$1-$2-remon-noipmon"
    server-bench "$__benchmark_dir_out/nginx-1.23.3/pmvee/single/sbin/nginx" "$__output_dir/$__connections-connections/nginx$1-$2-pmvee-noipmon"
    ...
    orig-server-bench "$__benchmark_dir_out/nginx-1.23.3/base/sbin/nginx" "$__output_dir/$__connections-connections/nginx$1-$2-remon-withipmon"
    server-bench "$__benchmark_dir_out/nginx-1.23.3/pmvee/single/sbin/nginx" "$__output_dir/$__connections-connections/nginx$1-$2-pmvee-withipmon"

    execute_and_wait "cd $__benchmark_dir/nginx-1.23.3/ && ./build.sh --ngx-split --pmvee-extra --mappings-single 1>/dev/null"
    execute_and_wait "cd $__remon_dir/PMVEE && make lib 1>/dev/null"
    execute_and_wait "ln -fs $__orig_remon_dir/IP-MON/libipmon-nginx.so $__orig_remon_dir/IP-MON/libipmon.so"

    __ld_preload=""
    execute_and_wait "sed -i 's/\"use_ipmon\" : 1/\"use_ipmon\" : 0/g' $__remon_exec_dir/MVEE.ini"
    server-bench "$__benchmark_dir_out/nginx-1.23.3/pmvee/single/sbin/nginx" "$__output_dir/$__connections-connections/nginx-emulate-$1-$2-pmvee-noipmon"

    __ld_preload=""
    execute_and_wait "sed -i 's/\"use_ipmon\" : 0/\"use_ipmon\" : 1/g' $__remon_exec_dir/MVEE.ini"
    server-bench "$__benchmark_dir_out/nginx-1.23.3/pmvee/single/sbin/nginx" "$__output_dir/$__connections-connections/nginx-emulate-$1-$2-pmvee-withipmon"
...
function mapping-count-benchmark
{
    ...
    scp benchmark:/tmp/pmvee_temp_log_copy_later $__output_dir/native
    ...
    scp benchmark:/tmp/pmvee_temp_log_copy_later $__output_dir/native_sync
    ...
    scp benchmark:/tmp/pmvee_temp_log_copy_later $__output_dir/pmvee
    ...
    scp benchmark:/tmp/pmvee_temp_log_copy_later $__output_dir/pmvee-ipmon
}
...
# 
    ...
    # done
    # scp benchmark:/tmp/pmvee_temp_log_copy_later $__output_dir/pmvee-micro
# 
    # execute_and_wait "sed -i 's/\"use_ipmon\" : 0/\"use_ipmon\" : 1/g' $__remon_exec_dir/MVEE.ini"
    # execute_and_wait "sed -i 's/\"use_ipmon\" : 0/\"use_ipmon\" : 1/g' $__orig_remon_exec_dir/MVEE.ini"
    # execute_and_wait "echo "" > /tmp/pmvee_temp_log_copy_later"
    ...
    #     execute_and_wait "cd $__remon_exec_dir && ./mvee -- $__benchmark_dir/microbenchmarks/switcheroo/bin/switcheroo_pmvee >> /tmp/pmvee_temp_log_copy_later"
    # done
    # scp benchmark:/tmp/pmvee_temp_log_copy_later $__output_dir/pmvee-ipmon-micro
# 
# 
